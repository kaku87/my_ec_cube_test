...
class __TwigTemplate_763fccddb5102c6d998ffa884a2cdb20d002a58dd03e8fc0e4cffcfd486c2142 extends Twig_Template
{
        ...
        <div class=\"table-responsive with-border\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["Plugin"]) {
                ...
                echo "</p>
                                ";
                // line 58
                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array(), "any", false, true), $this->getAttribute($context["Plugin"], "code", array()), array(), "array", false, true), "const", array(), "any", false, true), "readme", array(), "any", true, true)) {
                    // line 59
                    echo "                                    <a href=\"#\" class=\"view_readme\" data-toggle=\"modal\" data-target=\"#readmeModal\" data-name=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["Plugin"], "name", array()), "html", null, true);
                    echo "\" data-readme=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), $this->getAttribute($context["Plugin"], "code", array()), array(), "array"), "const", array()), "readme"), "html", null, true);
                    echo "\">詳細を表示</a>
                                ";
                }
                // line 61
                ...
                if (($this->getAttribute($context["Plugin"], "source", array()) == 0)) {
                    ...
                    echo "
                                ";
                    // line 65
                    echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "plugin_id", array()), 'widget');
                    echo "
                                ";
                    // line 66
                    echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "plugin_archive", array()), 'widget', array("attr" => array("accept" => "application/zip,application/x-tar,application/x-gzip")));
                    echo "
                                ";
                    // line 67
                    echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "plugin_archive", array()), 'errors');
                    echo "
                                <p></p>
...
";
    ...
    {
        return new Twig_Source("", "Store/plugin_table.twig", "/home/ubuntu/workspace/src/Eccube/Resource/template/admin/Store/plugin_table.twig");
    }
}
