...
/* block.twig */
class __TwigTemplate_dba264c098095b7fde52f518aad383b7b2e0bc1c0dbdac0daff1801319135899 extends Twig_Template
{
    ...
    ";
            ...
            if ($this->getAttribute($context["Block"], "logic_flg", array())) {
                // line 25
                echo "        ";
                if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "http_cache", array()), "enabled", array())) {
                    // line 26
                    echo "            ";
...
";
    ...
    {
        return new Twig_Source("", "block.twig", "/home/ubuntu/workspace/src/Eccube/Resource/template/default/block.twig");
    }
}
